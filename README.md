...
Download the latest DEB version from the [releases](https://github.com/neoslab/mediasane/releases/) section (the current version is v1.1.8) and use the following command:

```bash
cd /tmp/
wget https://github.com/neoslab/mediasane/releases/download/v1.1.8/mediasane_1.1.8_all.deb
sudo dpkg -i mediasane_1.1.8_all.deb
```
